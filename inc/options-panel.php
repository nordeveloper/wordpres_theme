<?php
    ...
    Redux::setSection( $opt_name, array(
        ...
        'desc'             => __( 'Контакты сайта ', 'redux-framework-demo' ) . '<a href="//docs.reduxframework.com/core/fields/checkbox/" target="_blank">docs.reduxframework.com/core/fields/checkbox/</a>',
        'fields'           => array(
            array(
                'id'       => 'head-phone',
                'type'     => 'text',
                ...
                'desc'     => __( 'Номер телефона в шапке', 'redux-framework-demo' ),
                'default'  => '',
            ),
        )
    ) );
